...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Continuous Delivery, Deployment, DevOps, Release Management, Kubernetes, Pipeline
...
#### Tags:
 ...
 - Delivery Pipelines, Targets, Releases, Rollouts

#### Properties

- [Documentation](https://cloud.google.com/deploy/docs/api/reference/rest)
- [OpenAPI](openapi/cloud-deploy-api-openapi.yml)
- [JSONSchema](json-schema/google-cloud-deploy-release-schema.json)

## Common Properties

- [GettingStarted](https://cloud.google.com/deploy/docs/quickstart)
...
- [CLI](https://cloud.google.com/sdk/gcloud/reference/deploy)
- [Support](https://cloud.google.com/deploy/docs/support)
- [Status](https://status.cloud.google.com)
- [JSON-LD](json-ld/google-cloud-deploy-context.jsonld)
